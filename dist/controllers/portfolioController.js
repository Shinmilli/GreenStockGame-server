...
exports.getPortfolioByTeam = void 0;
const models_1 = require("../models");
const errorHandler_1 = require("../utils/errorHandler");
const getPortfolioByTeam = async (req, res) => {
    try {
        ...
        // 보유 주식 조회
        const holdings = await models_1.prisma.holding.findMany({
        ...
        const { message, statusCode } = (0, errorHandler_1.handleControllerError)(error, '포트폴리오 조회');
        res.status(statusCode).json({ message });
    }
};
exports.getPortfolioByTeam = getPortfolioByTeam;
